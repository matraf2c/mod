...
import net.mcreator.matrafcs.procedures.TungsteneArmorHelmetTickEventProcedure;
import net.mcreator.matrafcs.init.MatrafcsModItems;

public abstract class TungstèneArmorItem extends ArmorItem {
	public TungstèneArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(MatrafcsModItems.TUNGSTENE_DUST.get()));
			}

			@Override
			public String getName() {
				return "tungstene_armor";
			}
	...
	public static class Helmet extends TungstèneArmorItem {
		...
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			TungsteneArmorHelmetTickEventProcedure.execute(entity);
		}
	}
