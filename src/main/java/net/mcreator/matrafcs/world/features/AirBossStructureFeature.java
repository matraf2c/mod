...
public class AirBossStructureFeature extends Feature<NoneFeatureConfiguration> {
	public static AirBossStructureFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new AirBossStructureFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("matrafcs:air_boss_structure", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("matrafcs:air_boss_structure", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public AirBossStructureFeature() {
